...
<div class="row body-content">
	...
	<div class="col-lg-6 float-auto">
		<div class="panel-card">
			<div class="panel-header">Admin Info</div>
			<div class="form-body">
				<form action="<?php echo base_url() ?>admin/updatedetails" method="post" enctype="multipart/form-data">
					...
					<div class="form-group  row">
						...
						<div class="col-sm-8">
							<input placeholder="Email Address" type="text" class="form-control form-control-sm" name="email-address" value="<?php echo $this->page_detail['username'] ?>">
						</div>
					</div>
