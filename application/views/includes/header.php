  	...
  	<div class="container">
  		<div class="row">
  			<div class="col-lg-3 col-md-3 d-lokj">
  				...
  				<img src="<?php echo base_url() ?>upload/admin/logoforum.png?<?php echo date("Ymd");?>" alt="Forum Helpdesk">
  				</a>
  			...
  			<div id="login" class="col-lg-4 col-md-5 d-none d-md-block center login-btns">
				<?php if(empty($this->single)){ ?>
					<button onclick="show_login()" type="button" class="btn btn-sm btn-info"><i class="fas fa-unlock-alt"></i> login</button>
