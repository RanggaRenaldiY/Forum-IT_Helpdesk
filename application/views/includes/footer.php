     ...
     <div class="modal-body">
       <p class="hid" id="login-err">User Name or Password Wrong</p>
         <div class="row no-margin form-row">
           ...
           <div class="col-sm-8">
             <input id="username" type="text" placeholder="Enter Username" class="form-control form-control-sm">
             <div class="smart-valid" id="username"></div>
           </div>
         </div>
         <div class="row no-margin form-row">
           <div class="col-sm-4">
     ...
     <div class="modal-body">
       ...
       <div class="row no-margin form-row">
         ...
         <div class="row no-margin form-row">
           ...
           <div class="col-sm-8">
             <input v-on:blur="unic_email()" id="username" type="text" name="username" placeholder="Enter Username" class="form-control form-control-sm">
